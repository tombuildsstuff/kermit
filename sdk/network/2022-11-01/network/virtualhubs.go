...
autorest.WithQueryParameters(queryParameters))
    ...
    // closes the http.Response Body.
    func (client VirtualHubsClient) GetEffectiveVirtualHubRoutesResponder(resp *http.Response) (result VirtualHubEffectiveRouteList, err error) {
            err = autorest.Respond(
            resp,
...
autorest.WithQueryParameters(queryParameters))
    ...
    // closes the http.Response Body.
    func (client VirtualHubsClient) GetInboundRoutesResponder(resp *http.Response) (result EffectiveRouteMapRouteList, err error) {
            err = autorest.Respond(
            resp,
            azure.WithErrorUnlessStatusCode(http.StatusOK,http.StatusAccepted),
            autorest.ByUnmarshallingJSON(&result),
...
autorest.WithQueryParameters(queryParameters))
    ...
    // closes the http.Response Body.
    func (client VirtualHubsClient) GetOutboundRoutesResponder(resp *http.Response) (result EffectiveRouteMapRouteList, err error) {
            err = autorest.Respond(
            resp,
            azure.WithErrorUnlessStatusCode(http.StatusOK,http.StatusAccepted),
            autorest.ByUnmarshallingJSON(&result),
