...
const fqdn = "home/runner/work/kermit/kermit/sdk/keyvault/7.5-preview.1/keyvault"
        ...
        objectMap := make(map[string]interface{})
            ...
            // HsmPlatform - READ-ONLY; The underlying HSM Platform.
        ...
        objectMap := make(map[string]interface{})
            ...
            // Type - The type of the action. The value should be compared case-insensitively. Possible values include: 'KeyRotationPolicyActionRotate', 'KeyRotationPolicyActionNotify'
    ...
    return err
        ...
        rdlr: cur,
            ...
            // UseManagedIdentity - Indicates which authentication method should be used. If set to true, Managed HSM will use the configured user-assigned managed identity to authenticate with Azure Storage. Otherwise, a SAS token has to be specified.
