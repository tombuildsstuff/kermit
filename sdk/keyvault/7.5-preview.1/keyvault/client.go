// Package keyvault implements the Azure ARM Keyvault service API version 7.5-preview.1.
//
	...
	if err := validation.Validate([]validation.Validation{
		{TargetValue: azureStorageBlobContainerURI,
			Constraints: []validation.Constraint{{Target: "azureStorageBlobContainerURI", Name: validation.Null, Rule: false,
				Chain: []validation.Constraint{{Target: "azureStorageBlobContainerURI.StorageResourceURI", Name: validation.Null, Rule: true, Chain: nil}}}}}}); err != nil {
