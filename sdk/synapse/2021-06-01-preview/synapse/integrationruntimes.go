...
// IntegrationRuntimesClient is the client for the IntegrationRuntimes methods of the Synapse service.
...
func (client IntegrationRuntimesClient) List(ctx context.Context) (result IntegrationRuntimeListResponse, err error) {
    ...
    if err != nil {
    err = autorest.NewErrorWithError(err, "synapse.IntegrationRuntimesClient", "List", nil , "Failure preparing request")
    return
    }
        ...
        if err != nil {
        result.Response = autorest.Response{Response: resp}
        err = autorest.NewErrorWithError(err, "synapse.IntegrationRuntimesClient", "List", resp, "Failure sending request")
        return
        }

        result, err = client.ListResponder(resp)
        if err != nil {
        err = autorest.NewErrorWithError(err, "synapse.IntegrationRuntimesClient", "List", resp, "Failure responding to request")
        return
        }
