...
autorest.WithQueryParameters(queryParameters))
    ...
    // closes the http.Response Body.
    func (client SQLPoolsClient) DeleteResponder(resp *http.Response) (result SQLPool, err error) {
            err = autorest.Respond(
            resp,
...
autorest.WithQueryParameters(queryParameters))
    ...
    // closes the http.Response Body.
    func (client SQLPoolsClient) PauseResponder(resp *http.Response) (result SQLPool, err error) {
            err = autorest.Respond(
            resp,
            azure.WithErrorUnlessStatusCode(http.StatusOK,http.StatusAccepted),
            autorest.ByUnmarshallingJSON(&result),
...
autorest.WithQueryParameters(queryParameters))
    ...
    // closes the http.Response Body.
    func (client SQLPoolsClient) ResumeResponder(resp *http.Response) (result SQLPool, err error) {
            err = autorest.Respond(
            resp,
            azure.WithErrorUnlessStatusCode(http.StatusOK,http.StatusAccepted),
            autorest.ByUnmarshallingJSON(&result),
...
func (client SQLPoolsClient) Update(ctx context.Context, resourceGroupName string, workspaceName string, SQLPoolName string, SQLPoolInfo SQLPoolPatchInfo) (result SQLPoolsUpdateFuture, err error) {
    if tracing.IsEnabled() {
    ...
    return
        ...
        if err != nil {
        err = autorest.NewErrorWithError(err, "synapse.SQLPoolsClient", "Update", result.Response(), "Failure sending request")
        return
        }
...
autorest.WithQueryParameters(queryParameters))
    ...
    // http.Response Body if it receives an error.
    func (client SQLPoolsClient) UpdateSender(req *http.Request) (future SQLPoolsUpdateFuture, err error) {
            var resp *http.Response
            future.FutureAPI = &azure.Future{}
            resp, err = client.Send(req, azure.DoRetryWithRegistration(client.Client))
            if err != nil {
