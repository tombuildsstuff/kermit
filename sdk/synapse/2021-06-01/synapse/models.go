...
const fqdn = "home/runner/work/kermit/kermit/sdk/synapse/2021-06-01/synapse"
...
func (future *BigDataPoolsDeleteFuture) result(client BigDataPoolsClient) (bdpri BigDataPoolResourceInfo, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
	...
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if bdpri.Response.Response, err = future.GetResult(sender); err == nil && bdpri.Response.Response.StatusCode != http.StatusNoContent {
		bdpri, err = client.DeleteResponder(bdpri.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "synapse.BigDataPoolsDeleteFuture", "Result", bdpri.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *IPFirewallRulesDeleteFuture) result(client IPFirewallRulesClient) (ifri IPFirewallRuleInfo, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
	...
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if ifri.Response.Response, err = future.GetResult(sender); err == nil && ifri.Response.Response.StatusCode != http.StatusNoContent {
		ifri, err = client.DeleteResponder(ifri.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "synapse.IPFirewallRulesDeleteFuture", "Result", ifri.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
// IntegrationRuntimeCustomerVirtualNetwork the definition and properties of virtual network to which
// Azure-SSIS integration runtime will join.
...
type ManagedIntegrationRuntime struct {
	// ProvisioningState - READ-ONLY; Integration runtime state, only valid for managed dedicated integration runtime. Possible values include: 'IntegrationRuntimeStateInitial', 'IntegrationRuntimeStateStopped', 'IntegrationRuntimeStateStarted', 'IntegrationRuntimeStateStarting', 'IntegrationRuntimeStateStopping', 'IntegrationRuntimeStateNeedRegistration', 'IntegrationRuntimeStateOnline', 'IntegrationRuntimeStateLimited', 'IntegrationRuntimeStateOffline', 'IntegrationRuntimeStateAccessDenied'
...
func (mir *ManagedIntegrationRuntime) UnmarshalJSON(body []byte) error {
	...
	for k, v := range m {
		...
		case "provisioningState":
			if v != nil {
				var provisioningState IntegrationRuntimeState
				err = json.Unmarshal(*v, &provisioningState)
				if err != nil {
					return err
				}
				mir.ProvisioningState = provisioningState
			}
		case "typeProperties":
			if v != nil {
...
func (mire ManagedIntegrationRuntimeError) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	for k, v := range mire.AdditionalProperties {
		objectMap[k] = v
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for ManagedIntegrationRuntimeError struct.
func (mire *ManagedIntegrationRuntimeError) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		default:
			if v != nil {
				...
				if mire.AdditionalProperties == nil {
					mire.AdditionalProperties = make(map[string]interface{})
				}
				mire.AdditionalProperties[k] = additionalProperties
			}
		case "time":
			if v != nil {
...
func (mirn ManagedIntegrationRuntimeNode) MarshalJSON() ([]byte, error) {
	...
	for k, v := range mirn.AdditionalProperties {
		objectMap[k] = v
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for ManagedIntegrationRuntimeNode struct.
func (mirn *ManagedIntegrationRuntimeNode) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		default:
			if v != nil {
				...
				if mirn.AdditionalProperties == nil {
					mirn.AdditionalProperties = make(map[string]interface{})
				}
				mirn.AdditionalProperties[k] = additionalProperties
			}
		case "nodeId":
			if v != nil {
				var nodeID string
		...
		case "status":
			if v != nil {
				var status ManagedIntegrationRuntimeNodeStatus
		...
		case "errors":
			if v != nil {
				var errorsVar []ManagedIntegrationRuntimeError
				err = json.Unmarshal(*v, &errorsVar)
				if err != nil {
					return err
				}
				mirn.Errors = &errorsVar
			}
		}
	}
...
func (miror ManagedIntegrationRuntimeOperationResult) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	for k, v := range miror.AdditionalProperties {
		objectMap[k] = v
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for ManagedIntegrationRuntimeOperationResult struct.
func (miror *ManagedIntegrationRuntimeOperationResult) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		default:
			if v != nil {
				...
				if miror.AdditionalProperties == nil {
					miror.AdditionalProperties = make(map[string]interface{})
				}
				miror.AdditionalProperties[k] = additionalProperties
			}
		case "type":
			if v != nil {
				var typeVar string
		...
		case "result":
			if v != nil {
				...
				miror.Result = &resultVar
			}
		case "errorCode":
			if v != nil {
				var errorCode string
				err = json.Unmarshal(*v, &errorCode)
				if err != nil {
					return err
				}
				miror.ErrorCode = &errorCode
			}
		case "parameters":
			if v != nil {
				var parameters []string
...
// SQLPoolOperationResultsGetLocationHeaderResultFuture an abstraction for monitoring and retrieving the
// results of a long-running operation.
type SQLPoolOperationResultsGetLocationHeaderResultFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(SQLPoolOperationResultsClient) (SQLPool, error)
}

// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *SQLPoolOperationResultsGetLocationHeaderResultFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for SQLPoolOperationResultsGetLocationHeaderResultFuture.Result.
func (future *SQLPoolOperationResultsGetLocationHeaderResultFuture) result(client SQLPoolOperationResultsClient) (sp SQLPool, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.SQLPoolOperationResultsGetLocationHeaderResultFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		sp.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.SQLPoolOperationResultsGetLocationHeaderResultFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if sp.Response.Response, err = future.GetResult(sender); err == nil && sp.Response.Response.StatusCode != http.StatusNoContent {
		sp, err = client.GetLocationHeaderResultResponder(sp.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "synapse.SQLPoolOperationResultsGetLocationHeaderResultFuture", "Result", sp.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *SQLPoolsDeleteFuture) result(client SQLPoolsClient) (sp SQLPool, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
	...
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if sp.Response.Response, err = future.GetResult(sender); err == nil && sp.Response.Response.StatusCode != http.StatusNoContent {
		sp, err = client.DeleteResponder(sp.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "synapse.SQLPoolsDeleteFuture", "Result", sp.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *SQLPoolsPauseFuture) result(client SQLPoolsClient) (sp SQLPool, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
	...
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if sp.Response.Response, err = future.GetResult(sender); err == nil && sp.Response.Response.StatusCode != http.StatusNoContent {
		sp, err = client.PauseResponder(sp.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "synapse.SQLPoolsPauseFuture", "Result", sp.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (future *SQLPoolsResumeFuture) result(client SQLPoolsClient) (sp SQLPool, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
	...
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if sp.Response.Response, err = future.GetResult(sender); err == nil && sp.Response.Response.StatusCode != http.StatusNoContent {
		sp, err = client.ResumeResponder(sp.Response.Response)
		if err != nil {
			err = autorest.NewErrorWithError(err, "synapse.SQLPoolsResumeFuture", "Result", sp.Response.Response, "Failure responding to request")
		}
	}
	return
}

// SQLPoolsUpdateFuture an abstraction for monitoring and retrieving the results of a long-running
// operation.
type SQLPoolsUpdateFuture struct {
	azure.FutureAPI
	// Result returns the result of the asynchronous operation.
	// If the operation has not completed it will return an error.
	Result func(SQLPoolsClient) (SQLPool, error)
...
// UnmarshalJSON is the custom unmarshaller for CreateFuture.
func (future *SQLPoolsUpdateFuture) UnmarshalJSON(body []byte) error {
	var azFuture azure.Future
	if err := json.Unmarshal(body, &azFuture); err != nil {
		return err
	}
...
// result is the default implementation for SQLPoolsUpdateFuture.Result.
func (future *SQLPoolsUpdateFuture) result(client SQLPoolsClient) (sp SQLPool, err error) {
	var done bool
	done, err = future.DoneWithContext(context.Background(), client)
	if err != nil {
		err = autorest.NewErrorWithError(err, "synapse.SQLPoolsUpdateFuture", "Result", future.Response(), "Polling failure")
		return
	}
	if !done {
		sp.Response.Response = future.Response()
		err = azure.NewAsyncOpIncompleteError("synapse.SQLPoolsUpdateFuture")
		return
	}
	sender := autorest.DecorateSender(client, autorest.DoRetryForStatusCodes(client.RetryAttempts, client.RetryDuration, autorest.StatusCodesForRetry...))
	if sp.Response.Response, err = future.GetResult(sender); err == nil && sp.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "synapse.SQLPoolsUpdateFuture", "Result", sp.Response.Response, "Failure responding to request")
		}
	}
	return
}
...
func (shirn SelfHostedIntegrationRuntimeNode) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	for k, v := range shirn.AdditionalProperties {
		objectMap[k] = v
	}
	return json.Marshal(objectMap)
}

// UnmarshalJSON is the custom unmarshaler for SelfHostedIntegrationRuntimeNode struct.
func (shirn *SelfHostedIntegrationRuntimeNode) UnmarshalJSON(body []byte) error {
	var m map[string]*json.RawMessage
	err := json.Unmarshal(body, &m)
	if err != nil {
		return err
	...
	for k, v := range m {
		...
		default:
			if v != nil {
				...
				if shirn.AdditionalProperties == nil {
					shirn.AdditionalProperties = make(map[string]interface{})
				}
				shirn.AdditionalProperties[k] = additionalProperties
			}
		case "nodeName":
			if v != nil {
				var nodeName string
		...
		case "hostServiceUri":
			if v != nil {
				...
				shirn.HostServiceURI = &hostServiceURI
			}
		case "status":
			if v != nil {
				var status SelfHostedIntegrationRuntimeNodeStatus
				err = json.Unmarshal(*v, &status)
				if err != nil {
					return err
				}
		...
		case "capabilities":
			if v != nil {
				...
				shirn.Capabilities = capabilities
			}
		case "versionStatus":
			if v != nil {
				var versionStatus string
				err = json.Unmarshal(*v, &versionStatus)
				if err != nil {
					return err
				}
				shirn.VersionStatus = &versionStatus
			}
		case "version":
			if v != nil {
				var version string
				...
				shirn.Version = &version
			}
		case "registerTime":
			if v != nil {
				var registerTime date.Time
				err = json.Unmarshal(*v, &registerTime)
				if err != nil {
					return err
				}
				shirn.RegisterTime = &registerTime
			}
		case "lastConnectTime":
			if v != nil {
				var lastConnectTime date.Time
				err = json.Unmarshal(*v, &lastConnectTime)
				if err != nil {
					return err
				}
				shirn.LastConnectTime = &lastConnectTime
			}
		case "expiryTime":
			if v != nil {
				var expiryTime date.Time
				err = json.Unmarshal(*v, &expiryTime)
				if err != nil {
					return err
				}
				shirn.ExpiryTime = &expiryTime
			}
		case "lastStartTime":
			if v != nil {
				var lastStartTime date.Time
				err = json.Unmarshal(*v, &lastStartTime)
				if err != nil {
					return err
				}
				shirn.LastStartTime = &lastStartTime
			}
		case "lastStopTime":
			if v != nil {
				var lastStopTime date.Time
				err = json.Unmarshal(*v, &lastStopTime)
				if err != nil {
					return err
				}
				shirn.LastStopTime = &lastStopTime
			}
		case "lastUpdateResult":
			if v != nil {
				var lastUpdateResult IntegrationRuntimeUpdateResult
				err = json.Unmarshal(*v, &lastUpdateResult)
				if err != nil {
					return err
				}
				shirn.LastUpdateResult = lastUpdateResult
			}
		case "lastStartUpdateTime":
			if v != nil {
				var lastStartUpdateTime date.Time
				err = json.Unmarshal(*v, &lastStartUpdateTime)
				if err != nil {
					return err
				}
				shirn.LastStartUpdateTime = &lastStartUpdateTime
			}
		case "lastEndUpdateTime":
			if v != nil {
				var lastEndUpdateTime date.Time
				err = json.Unmarshal(*v, &lastEndUpdateTime)
				if err != nil {
					return err
				}
				shirn.LastEndUpdateTime = &lastEndUpdateTime
			}
		case "isActiveDispatcher":
			if v != nil {
				var isActiveDispatcher bool
				err = json.Unmarshal(*v, &isActiveDispatcher)
				if err != nil {
					return err
				}
				shirn.IsActiveDispatcher = &isActiveDispatcher
			}
		case "concurrentJobsLimit":
			if v != nil {
				var concurrentJobsLimit int32
				...
				shirn.ConcurrentJobsLimit = &concurrentJobsLimit
			}
		case "maxConcurrentJobs":
			if v != nil {
				var maxConcurrentJobs int32
				...
				shirn.MaxConcurrentJobs = &maxConcurrentJobs
			}
		}
	}
...
func (future *WorkspacesDeleteFuture) result(client WorkspacesClient) (w Workspace, err error) {
	...
	if w.Response.Response, err = future.GetResult(sender); err == nil && w.Response.Response.StatusCode != http.StatusNoContent {
		...
		if err != nil {
			err = autorest.NewErrorWithError(err, "synapse.WorkspacesDeleteFuture", "Result", w.Response.Response, "Failure responding to request")
		}
	}
	return
}
