...
resource_manager "recoveryservicesbackup" "2022-03-01" {
  swagger_tag = "package-2022-03"
  readme_file_path = "../../swagger/specification/recoveryservicesbackup/resource-manager/readme.md"
}
